...
public:
    ...
    */
    ...
    bool GetOneMsg(std::vector<unsigned char>& result);
...
private:
     ...
     */
    static std::vector<unsigned char>::iterator findStringInVector(std::vector<unsigned char>& v,
            const std::string& s);

    std::vector<unsigned char>::iterator findBytesInVector(
        std::vector<unsigned char>& v, int find_offset, const std::vector<unsigned char>& s);

    std::vector<unsigned char>::iterator replaceBytesInVector(
        std::vector<unsigned char>& v, const std::vector<unsigned char>& s, const std::vector<unsigned char>& r);

    std::vector<unsigned char> readQueue;
